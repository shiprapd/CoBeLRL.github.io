...
class BlenderFrontend():
    """
    This class creates a basic frontend and communicates with blender
    """
    ...
    def calculateWheelInjectedSpeeds(self, v, omega, b=1.0, r=0.02):
        ...
        :return vR: right wheel velocity
        """
        # set variables
        b, r = b, r
    ...
    def stepSimulation(self, data):
        ...
        :param data: contains the data string of desired left and right wheel velocity
        :return: None
        """
        ...
        sendString = '%.5f:%.3f,%.3f,%.3f,%.3f:%.3f,%.3f,%.3f,%.3f,%.3f,%.3f,%.3f,%.3f' % (
            self.simulationTime, self.robotSupport.worldPosition[0], self.robotSupport.worldPosition[1], headingX,
            headingY,
            self.sensorArray[0], self.sensorArray[1], self.sensorArray[2], self.sensorArray[3], self.sensorArray[4],
            self.sensorArray[5], self.sensorArray[6], self.sensorArray[7])
    ...
    def stepSimNoPhysics(self, data):
        ...
        currentX, currentY, currentZ = self.robotSupport.worldPosition[0], self.robotSupport.worldPosition[1], \
                                       self.robotSupport.worldPosition[2]
    ...
    def setVelocity(self, data):
        ...
        :param data: contains the data string of desired linear and angular velocity
        :return: None
        """
    ...
    def suspendDynamics(self, data):
        ...
        :param data: The object for which dynamic should be suspended
        :return: None
        """
        # split data string
        objectName = data
    ...
    def restoreDynamics(self, data):
        """
        This function restores the dynamics for a given object and sends control data.
    ...
    def renderLine(self, data):
        """
        This function renders a line and send control data.

        :param data: data parameters contains start and end co-ordinates in X,Y and Z planes.
        :return: None
        """
    ...
    def teleportObject(self, data):
        ...
        :param data: data parameter contains pose data in X,Y,Z, roll, pitch and yaw.
        :return: None
        """
    ...
    def setXYYaw(self, data):
        ...
        :param data: data parameter contains X,Y positions and yaw in degrees
        :return: None
        """
        # objectName:                   The object name.
        # xStr:                         The desired x position.
    ...
    def setIllumination(self, data):
        ...
        :param data: data parameters contains the lightSource name and desired values for R,G and B
        :return: None
        """
