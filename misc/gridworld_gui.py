...
def updateProbability(world, index, probabilities=[]):
    ...
    :param world: The gridworld  directory created using the  makeGridworld function
    :param index: The index of the state that is being edited
    :param probabilities: The changed transition probabilities
    :return: None
    """
...
def updateTransitions(world, invalidStates=[], invalidTransitions=[]):
    """
    Updates the world  directory according to the applied changes, through double-clicking the state borders.

    :param world: The gridworld directory created using the makeGridworld function
    :param invalidStates: All states which have become unreachable
    :param invalidTransitions: All transition which have turned invalid
    :return: None
    """
...
def updateState(world, index, reward, terminal, starting, none):
    ...
    :param world: The gridworld  directory created using the  makeGridworld function
    :param index: The index of the state that is being edited
    :param reward: The reward value that will be used for the world directory
    :param terminal: Is true if the state will be of type terminal
    :param starting: Is true if the state will be of type starting
    :param none: Is true if the state will be neither terminal nor starting
    :return: None
    """
...
class Settings():
    """
    This class defines the world setting.
    """
    WORLD = dict()
...
class Line(QtWidgets.QGraphicsLineItem):
    """
    An extended version of the standard QGraphicsLineItem, to provide the on-click ability to change borders to invalid and turn
    """
    def __init__(self, x1, y1, x2, y2, pen):
        """
        Inits the standard QGraphicsLineItem, to provide the on-click ability to change borders to invalid and turn
        red
        ...
        :param pen: The pen, that draws the line
        :return: None
        """
    ...
    def unhighlight(self):
        """
        This function turns a red line back to being a white line.
    ...
    def checkInvalidState(self, index):
        """
        This functions checks if a state is no longer reachable by the virtual agent, because all possible transition have turned invalid
        This only works for deterministic gridworlds
        
        :param index: Index of the state which is checked
        :return: None
        """
...
class Grid(QGraphicsScene):
    """
    This class draws grid in the graphics.
    """
    def __init__(self, parent=None):
        """
        Inits class draws grid in the graphics.
    ...
    def set_visible(self, visible=True):
        """
        This function sets the grid visible/invisible

        :param visible: Boolean, whether the grid s visible or not
        :return: None
        """
    ...
    def set_opacity(self, opacity):
        ...
        :param opacity: The opacity the lines will have
        :return: None
        """
        for line in self.lines:
    ...
    def highlight_terminal_starting(self, terminals, startings):
        """
        This function highlights the states according to terminal and
        starting state list in the  WORLD directory

        :param terminals: The terminal state list in the WORLD dict
        :param startings: The starting state  list in the WOLRD dict
        :return: None
        """
...
class GridViewer(QGraphicsView):
    """
    This class enables viewing grids
    """
...
class AdvancedSettingsWindow(QMainWindow):
    """
    Class for advanced settings of graphics windows
    """
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        QMainWindow.__init__(self)
...
class CentralPanel(QWidget):
    """
    Class for central Panel graphics
    """
    def __init__(self):
        QWidget.__init__(self)
    ...
    def changeStateInfo(self, textCoord, index):
        """
        Used to pass the function to the children of Central Panel.

        :param textCoord:  states coordinates
    ...
    def highlight_terminal_starting(self, terminals, startings):
        ...
        :param terminals: worlds terminal states
        :param startings: worlds starting states
        :return: None
        """
...
class MainWindow(QMainWindow):
    """
    Class for main window graphics
    """
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        QMainWindow.__init__(self)
    ...
    def save(self, fname):
        ...
        :param fname: File name/Target file.
        :return: None
        """
    ...
    def unsavedChanges(self):
        """
        This function opens a dialog window to ask the user to save the
...
class unsavedChangesDialog(QDialog):
    """
    This class stores the unsaved changes in the dialog
    """
    def __init__(self, parent=None):
