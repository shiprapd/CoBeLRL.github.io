...
class OAIGymInterface(gym.Env):
    """
    Open AI interface class for use with gridworld environments.
    """
    
    def __init__(self, modules, world, withGUI=True, guiParent=None, rewardCallback=None):
        """
        Inits Open AI interface for use with gridworld environments.

        :param modules:                      Contains framework modules
        :param world:                        The gridworld
        :param withGUI:                      If true, observations and policy will be visualized
        :param guiParent:                    The main window for visualization
        :param rewardCallback:               The callback function used to compute the reward
        :return: None
        """
        # store the modules
    ...
    def step(self, action):
        """
        AI Gym's step function, executes the agent's action and propels the simulation.
    ...
    def reset(self):
        """
        AI Gym's reset function, resets the environment and the agent's state.
    ...
    def updateVisualization(self):
        """
        This function updates visualization if visualization is enabled.
