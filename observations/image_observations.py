...
class ImageObservationBaseline():
    """
    This class computes an observation based on the current camera image acquired by the robot/agent.
    """
    ...
    def __init__(self, world,guiParent,visualOutput=True):
        """
        Inits constructor for computes an observation based on the current camera image acquired by the robot/agent.

        :param world:        the world module
        :param guiParent:    the main window for visualization
        :param visualOutput: flag for the module to provide visual output
        :return: None
        """
